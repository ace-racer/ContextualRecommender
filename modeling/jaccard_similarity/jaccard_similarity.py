...
stream_tag_frequency_location = "/Users/shriyashekhar/Documents/IWork/ProcessedData/tag_frequency_streams.csv"
min_distance_threshold = 0
nearest_neighbors_streams_output_file = "/Users/shriyashekhar/Documents/IWork/ProcessedData/jaccard_nearest_neighbor_streams.csv"
...
for stream_row_num in range(1, num_streams + 1):
    ...
    for other_stream_row_num in range(1, num_streams + 1):
        ...
        if other_stream_row_num != stream_row_num:
            distance = jaccard(source_stream_tag_frequencies, other_stream_tag_frequencies)
