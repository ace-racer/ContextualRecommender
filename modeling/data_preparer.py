...
content_views_by_card_by_user_location = os.path.join(configurations.OUTPUT_FILES_DIRECTORY, CONTENT_VIEWS_BY_USER_BY_CARD_GENERATED_FILE_NAME)
content_views_by_user.to_csv(content_views_by_card_by_user_location)
print("Content views by user by card generated: " + content_views_by_card_by_user_location)